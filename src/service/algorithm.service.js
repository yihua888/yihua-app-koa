...
class AlgorithmService {
    ...
    async getAlgorithms (algorithmName, algorithmType, limit, offset) {
        ...
        from tb_algorithm a
        left join tb_algorithm_type atype on atype.id=a.type_id where 1=1 ` + condition + ` LIMIT ? , ?;`
        const statement1 = `select count(*) total from tb_algorithm a left join tb_algorithm_type atype on atype.id=a.type_id where 1=1 ` + condition
